...
const About = () => (
<<<<<<< HEAD:Frontend/src/pages/About.jsx
...
=======
  <div className="min-h-screen w-full bg-black text-white flex flex-col items-center py-8 sm:py-12 px-4">
    <div className="w-full flex justify-start mb-4">
      <span className="text-blue-400 text-sm sm:text-lg font-bold tracking-wide bg-gray-900 px-3 sm:px-4 py-2 rounded shadow border border-blue-400 ml-2 mt-2">ABOUT US</span>
    </div>
    <header className="flex flex-col items-center mb-8 sm:mb-10">
      <img src={logo} alt="CodeShiftAI Logo" className="w-20 h-20 sm:w-24 sm:h-24 object-contain mb-4" />
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-center">CodeShiftAI: Innovation in AI Coding Agents</h1>
      <p className="text-base sm:text-lg text-gray-300 mt-2 text-center max-w-2xl px-4">
        We are dedicated to revolutionizing the way developers build software. CodeShiftAI is an all-in-one AI coding agent that turns simple prompts into fully functional code, adapts to your style, and boosts your workflow with context-aware suggestions and automation.
      </p>
    </header>
    <section className="max-w-2xl w-full mb-6 sm:mb-8 px-4">
      <h2 className="text-xl sm:text-2xl font-bold mb-4 text-blue-400 tracking-wide">Our Mission</h2>
      <p className="text-base sm:text-lg text-gray-300 mb-4">
        Our mission is to empower developers and teams to build faster, smarter, and with more creativity. Whether you need to scaffold projects, fix bugs, or generate components, CodeShiftAI is designed to understand your needs and deliver results efficiently.
      </p>
      <div className="bg-gradient-to-r from-blue-600 to-green-400 text-black font-bold text-base sm:text-lg rounded-lg px-4 sm:px-6 py-3 sm:py-4 mb-4 shadow-lg border-2 border-blue-400">
        "It doesn't just suggest code. It builds it."
      </div>
    </section>
    <section className="max-w-3xl w-full px-4">
      <h2 className="text-xl sm:text-2xl font-bold mb-4 text-blue-400 tracking-wide">What Makes Us Unique?</h2>
>>>>>>> deep:src/pages/About.jsx
